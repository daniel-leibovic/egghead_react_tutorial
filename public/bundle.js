...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactRouter2['default'].run(_configRoutes2['default'], _reactRouter2['default'].HistoryLocation, function (Root, state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsHome = __webpack_require__(201);

	var _componentsHome2 = _interopRequireDefault(_componentsHome);

	var _componentsProfile = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoggedIn = __webpack_require__(200);
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'container' },
	          accessToken ? _react2['default'].createElement(_LoggedIn2['default'], { accessToken: accessToken, refreshToken: refreshToken }) : _react2['default'].createElement(_Login2['default'], null),
	...
	var SearchGithub = (function (_React$Component) {
		...
		_createClass(SearchGithub, [{
			...
			value: function handleSubmit() {
				//ES6 classes do not allow mixins, have to pass in as function from parent...
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Oauth = __webpack_require__(232);
	...
	var LoggedIn = (function (_React$Component) {
	  ...
	  function LoggedIn() {
	    ...
	    _get(Object.getPrototypeOf(LoggedIn.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(LoggedIn, [{
	    ...
	    value: function render() {
	      ...
	      var refreshToken = _props.refreshToken;

	      return _react2['default'].createElement(
	        'div',
	        { id: 'loggedin' },
	        _react2['default'].createElement(_UserProfile2['default'], { accessToken: accessToken }),
	        _react2['default'].createElement(_Oauth2['default'], { accessToken: accessToken, refreshToken: refreshToken }),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this._handleClick, className: 'btn btn-default', id: 'obtain-new-token' },
	    ...
	    value: function _handleClick() {
	      ...
	      _utilsHelpers2['default'].getRefreshToken(this.props.refreshToken).then((function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GithubUserProfile = __webpack_require__(206);

	var _GithubUserProfile2 = _interopRequireDefault(_GithubUserProfile);

	var _GithubRepos = __webpack_require__(207);
	...
	var base = _reBase2['default'].createClass('https://blistering-torch-1634.firebaseio.com/');
		...
		_createClass(Notes, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_AddNote2['default'], { addNote: this.props.addNote }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	  ...
	  getSpotifyUserInfo: function getSpotifyUserInfo(accessToken) {
	    return _axios2['default'].get('https://api.spotify.com/v1/me', {
	      headers: {
	  ...
	  getRefreshToken: function getRefreshToken(refreshToken) {
	    return _axios2['default'].get('/refresh_token', {
	      data: {
	...
	var UserProfile = (function (_React$Component) {
	  ...
	  _createClass(UserProfile, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      _utilsHelpers2['default'].getSpotifyUserInfo(this.props.accessToken).then((function (response) {
	    ...
	    value: function render() {
	      ...
	      var display_name = _state.display_name;
	      var id = _state.id;
	      var email = _state.email;
	      var external_urls = _state.external_urls;
	      var href = _state.href;
	      var images = _state.images;
	      var country = _state.country;
	      var spotify = _state.spotify;

	      return _react2['default'].createElement(
	        'div',
	        null,
	        !images ? null : _react2['default'].createElement(
	          'div',
	          null,
	          _react2['default'].createElement(
	            'h1',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'pull-left' },
	              _react2['default'].createElement('img', { className: 'media-object', width: '150', src: images[0].url })
	            ),
	            _react2['default'].createElement(
	              'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Oauth = (function (_React$Component) {
	  _inherits(Oauth, _React$Component);

	  function Oauth() {
	    _classCallCheck(this, Oauth);

	    _get(Object.getPrototypeOf(Oauth.prototype), "constructor", this).apply(this, arguments);
	  }
